...
const gameReadyPresetLabel = 'Game Ready 512 Strip';
const gameReadySpec = { stripWidth: 3072, stripHeight: 512, frameCount: 6, frameWidth: 512, frameHeight: 512, baselineY: 460 };
...
const exportSizePresets = [
  ...
  { width: 512, height: 512, label: gameReadyPresetLabel },
...
const seamJointPairs = new Set(['torso:front_arm','torso:rear_arm','torso:front_leg','torso:rear_leg','torso:head']);
  ...
  const generateStripAndPreview = () => {
    ...
    const useGameReadyProfile = state.frameCount === gameReadySpec.frameCount && state.cellWidth === gameReadySpec.frameWidth && state.cellHeight === gameReadySpec.frameHeight && selectedPresetLabel === gameReadyPresetLabel;
