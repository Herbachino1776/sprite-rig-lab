...
import { defaultState, defaultPartNames, globularPartNames, quadrupedPartNames, type JawMode, type JawSettings, type MaskPart, type ProjectSaveData, type RigTemplate } from './state/projectState';
