...
const syncIdleReadout = () => {
    ...
    q<HTMLDivElement>('idleControlGrid').hidden = animationMode === 'part-based-small-walk' || animationMode === 'part-based-attack' || animationMode === 'part-based-globular-crawl';
    ...
    q<HTMLDivElement>('globularCrawlControlGrid').hidden = animationMode !== 'part-based-globular-crawl';
    q<HTMLDivElement>('quadrupedWalkControlGrid').hidden = animationMode !== 'part-based-quadruped-walk';
    syncJawUi();
