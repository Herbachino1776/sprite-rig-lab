...
import { defaultState, defaultPartNames, globularPartNames, quadrupedPartNames, type MaskPart, type ProjectSaveData, type RigTemplate } from './state/projectState';
